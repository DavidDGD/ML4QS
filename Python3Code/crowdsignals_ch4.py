...
def main():
    ...
    if FLAGS.mode == 'final':
        ...
        DataViz.plot_dataset(dataset, ['acc_phone_x', 'gyr_phone_x', 'light_phone_lux', 'mag_phone_x', 'pca_1', 'label'], ['like', 'like', 'like', 'like', 'like', 'like','like'], ['line', 'line', 'line', 'line', 'line', 'line', 'points'])
