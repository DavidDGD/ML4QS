...
for milliseconds_per_instance in GRANULARITIES:
    ...
    dataset.add_event_dataset('labels.csv', 'start_time', 'end_time', 'labels', 'binary')
    ...
    # Boxplot
    DataViz.plot_dataset_boxplot(dataset, ['acc_phone_x','acc_phone_y','acc_phone_z','gyr_phone_x','gyr_phone_y','gyr_phone_z', 'mag_phone_x','mag_phone_y','mag_phone_z', 'light_phone_lux'])
